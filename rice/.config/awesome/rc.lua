...
globalkeys = gears.table.join(
    ...
    --       -- return awful.rules.match(c, {class = "URxvt"})
    --     end
    --     for c in awful.client.iterate(pred) do
    --         client.focus = c
    --         client.focus:raise()
    --     end
    -- end),
    ...
    awful.key({ modkey, "Shift" }, "x",
        ...
        {description = "minimize other clients amd select previous layout", group = "client"}),
...
clientkeys = gears.table.join(
    ...
    -- awful.key({ modkey, "Ctrl" }, "n",
        -- function (c)
          -- rice.minimize_others()
        -- end ,
        -- {description = "minimize other clients", group = "client"}),
    -- awful.key({ modkey,           }, "n",
        -- function (c)
...
-- Only show decorations on floating windows
...
-- Show/Hide title bars when layout is switched between floating/non-floating layout
